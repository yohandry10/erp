          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-blue-900">S/ {totalGeneral.toFixed(2)}</p>
              </div>
              <div className="bg-green-50 rounded-lg p-4">
                <p className="text-sm text-green-600 font-medium">Total Pedidos</p>
                <p className="text-2xl font-bold text-green-900">{totalPedidos}</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4">
                <p className="text-sm text-purple-600 font-medium">Total Facturas</p>
                <p className="text-2xl font-bold text-purple-900">{totalFacturas}</p>
              </div>
            </div>
