              ...
              ">
                ...
                ">
                  <div style="margin-bottom: 1rem;">
                    <label style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 0.25rem;">
                      EMAIL
                    </label>
                    <div style="
                      background: white; border: 1px solid #e2e8f0;
                      border-radius: 8px; padding: 0.75rem;
                      font-family: monospace; font-size: 0.9rem; color: #1e293b;
                    ">
                      ${adminUser.email}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div style="
                      background: white; border: 1px solid #e2e8f0;
                      border-radius: 8px; padding: 0.75rem;
                      font-family: monospace; font-size: 0.9rem; color: #dc2626;
                      font-weight: 700;
                    ">
                ...
                <div style="
                  ...
                  border-radius: 8px; padding: 0.75rem; margin-bottom: 1.5rem;
