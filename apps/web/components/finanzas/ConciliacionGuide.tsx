...
export default function ConciliacionGuide() {
  return (
    <div className="rounded-lg p-8 text-white mb-8">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-4">
        <div className="bg-[rgba(255,_255,_255,_0.1)] rounded-lg p-4">
      ...
      <div className="mt-6 p-4 bg-[rgba(255,_255,_255,_0.15)] rounded-lg text-[0.875rem]">
