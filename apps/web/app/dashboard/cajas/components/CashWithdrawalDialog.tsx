                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {motivo === 'DEPOSITO_BANCARIO' && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">URL Foto Comprobante</label>
                                            <input
                                                type="text"
                                                className="mt-1 block w-full sm:text-sm border border-gray-300 rounded-md p-2"
                                                placeholder="https://..."
