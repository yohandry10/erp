      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-value">
            {currencySymbol} {stats?.ventasMes?.toLocaleString('es-PE', { minimumFractionDigits: 2 }) || '0.00'}
          </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">
            {currencySymbol} {stats?.comprasMes?.toLocaleString('es-PE', { minimumFractionDigits: 2 }) || '0.00'}
          </div>
          <div className="stat-subtitle">
                    ...
                    <div className="activity-meta-info">
                      ...
                      {activity.amount && (
                        <span className="activity-amount">
                          {currencySymbol} {activity.amount.toLocaleString('es-PE', { minimumFractionDigits: 2 })}
                        </span>
                      )}
                    </div>
                  </div>
