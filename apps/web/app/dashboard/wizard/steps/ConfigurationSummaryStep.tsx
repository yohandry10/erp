  ...
  return (
    <div style={{ padding: '1rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={sectionStyle}>
        ...
        <div style={rowStyle}>
          <span style={labelStyle}>IGV:</span>
      ...
      <div style={sectionStyle}>
        <h2 style={sectionTitleStyle}>🏛️ Configuración SUNAT</h2>
        <div style={rowStyle}>
          <span style={labelStyle}>OSE Activo:</span>
        ...
        {empresaConfig?.oseActivo && empresaConfig?.oseUrl && (
          <div style={rowStyle}>
            <span style={labelStyle}>URL OSE:</span>
