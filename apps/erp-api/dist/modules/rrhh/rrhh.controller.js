...
let RrhhController = class RrhhController {
    ...
    async pagarPlanillaCompleta(planillaId, pagoData) {
    ...
    async generarBoletaPago(empleadoId, mes) {
...
__decorate([
    (0, common_1.Post)('planillas/:id/pagar'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], RrhhController.prototype, "pagarPlanillaCompleta", null);
__decorate([
    (0, common_1.Post)('planillas/:id/pagar-empleados'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], RrhhController.prototype, "pagarEmpleadosSeleccionados", null);
__decorate([
    (0, common_1.Post)('planillas/:id/generar-asientos'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RrhhController.prototype, "generarAsientosContables", null);
__decorate([
    (0, common_1.Get)('planillas/:id/historial-pagos'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RrhhController.prototype, "getHistorialPagos", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('empleados/:id/boleta-pago/:mes'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('mes')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], RrhhController.prototype, "generarBoletaPago", null);
__decorate([
