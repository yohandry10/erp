...
export class ProveedoresController {
  ...
  @ApiQuery({
    name: "search",
    required: false,
    description: "Buscar por razón social, RUC o nombre comercial",
  })
  @ApiQuery({
    name: "estado",
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    description: "Filtrar por condiciones de pago",
  })
  @ApiQuery({
    name: "ruc",
    required: false,
    description: "Filtrar por RUC exacto",
  })
  @ApiQuery({
    name: "limit",
    required: false,
  ...
  @ApiResponse({
    status: 409,
    description: "Ya existe otro proveedor con ese RUC",
  })
  async update(
    @Param("id") id: string,
