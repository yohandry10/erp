...
- El PR #115 (`5c5b5d45`) está desplegado en Render y Vercel con esquema PROD
  555; API, DB, Redis, login y CORS respondieron. CI de `main` falló sólo en la
  descarga CSV intermitente de un navegador integrado. La corrección posterior
  pasó localmente con 100 HTTP y diez navegadores; falta CI y despliegue de esa
  corrección (`artifacts/peru-production-verification-after-115-20260923.json`).
