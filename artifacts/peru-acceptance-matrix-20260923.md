...
| Migración/importación de maestros y exportaciones | `artifacts/peru-integrated-20260923081953182-18656/http.json`: primer ADMIN no demo previsualiza clientes/proveedores, ejecuta dry-run sin escritura, importa archivo mixto con error por fila, consulta lote, reintenta sin duplicar y oculta lote ajeno con 404. La 554 pasa rollback atómico en copia restaurada de PROD. | Promover 554; importaciones CxC/CxP/saldos/stock/comprobantes; actualización y exportes descargables por rol; navegador y archivos grandes | Clientes/proveedores OK local API; resto pendiente |
...
- Producción: el PR #112 (`8f74ea3b`) pasó CI/E2E/seguridad y su API respondió
  ...
  La 554 para importar con el primer ADMIN permanece sin promover.
