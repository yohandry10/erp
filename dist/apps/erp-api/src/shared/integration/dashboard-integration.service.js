...
let DashboardIntegrationService = class DashboardIntegrationService {
    ...
    async getConsolidatedMetrics() {
        try {
            ...
            const [
            // Módulo POS - Ventas
            ventasHoyData, ventasMesData, ventasMesAnteriorData, 
            // Módulo Compras  
            comprasMesData, ordenesCompraPendientesData, 
            // Módulo Inventario
            productosData, productosStockBajoData, movimientosHoyData, 
            // Módulo CPE
            cpeDelMesData, 
            // Módulo GRE
            greDelMesData, 
            ...
            sireDelMesData, 
            // Módulo Cotizaciones
            cotizacionesDelMesData, cotizacionesPendientesData, cotizacionesAceptadasData, 
            // Sistema
