...
exports.default = GreViewModal;
const react_1 = require("react");
function GreViewModal({ isOpen, onClose, documentId }) {
    const [greData, setGreData] = (0, react_1.useState)(null);
          ...
          {loading ? (<div style={{
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                gap: '16px'
                          ...
                          <div>
                            {greData.transportista && (<p style={{ margin: '4px 0' }}>
                                <strong>Transportista:</strong> {greData.transportista}
                              </p>)}
                            {greData.placaVehiculo && (<p style={{ margin: '4px 0' }}>
                                <strong>Placa del Vehículo:</strong> {greData.placaVehiculo}
                              </p>)}
                          </div>
                          <div>
                            {greData.licenciaConducir && (<p style={{ margin: '4px 0' }}>
                        ...
                        {!greData.transportista && !greData.placaVehiculo && !greData.licenciaConducir && (<p style={{ margin: 0, color: '#6b7280', fontStyle: 'italic' }}>
              ...
              {/* OBSERVACIONES */}
              {greData.observaciones && (<div style={{ marginBottom: '24px' }}>
                  <table style={{
                    width: '100%',
                    borderCollapse: 'collapse',
                    border: '1px solid #000',
