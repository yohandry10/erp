...
exports.default = CpeViewModal;
const react_1 = require("react");
function CpeViewModal({ isOpen, onClose, documentId, documentType }) {
    const [cpeData, setCpeData] = (0, react_1.useState)(null);
          ...
          {loading ? (<div style={{
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                fontSize: '14px'
                          ...
                          <div>
                            <p style={{ margin: '4px 0' }}>
                              <strong>Tipo de Documento:</strong> {cpeData.tipo_documento_receptor === '1' ? 'DNI' :
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                fontWeight: 'bold'
                  ...
                  <tbody>
                    {Array.isArray(cpeData.items) && cpeData.items.length > 0 ? (cpeData.items.map((item, index) => (<tr key={index}>
                          <td style={{
                    border: '1px solid #000',
                    padding: '8px',
                    textAlign: 'center'
