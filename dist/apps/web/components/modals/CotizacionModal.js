...
exports.default = CotizacionModal;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
const use_toast_1 = require("@/components/ui/use-toast");
function CotizacionModal({ isOpen, onClose, onSuccess }) {
    ...
    const calcularTotales = (detallesActualizados) => {
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ backgroundColor: '#f9fafb', padding: '16px', borderRadius: '8px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
                <div>
                  ...
                  <select value={formData.cliente_id} onChange={(e) => handleInputChange('cliente_id', e.target.value)} style={{
            width: '100%',
            padding: '8px',
            ...
            fontSize: '14px'
                ...
                <div>
                  ...
                  <input type="text" value={formData.vendedor} onChange={(e) => handleInputChange('vendedor', e.target.value)} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
            fontSize: '14px'
                ...
                <div>
                  ...
                  <select value={formData.moneda} onChange={(e) => handleInputChange('moneda', e.target.value)} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
            fontSize: '14px'
                ...
                <div>
                  ...
                  <input type="date" value={formData.fecha_cotizacion} onChange={(e) => handleInputChange('fecha_cotizacion', e.target.value)} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
            fontSize: '14px'
                ...
                <div>
                  ...
                  <input type="date" value={formData.fecha_vencimiento} onChange={(e) => handleInputChange('fecha_vencimiento', e.target.value)} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
            fontSize: '14px'
                ...
                <div>
                  ...
                  <input type="number" min="0" max="100" value={formData.probabilidad} onChange={(e) => handleInputChange('probabilidad', parseInt(e.target.value))} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
            ...
            borderBottom: '1px solid #d1d5db'
                ...
                alignItems: 'center'
                    ...
                    <input type="text" value={detalle.codigo} onChange={(e) => handleDetalleChange(index, 'codigo', e.target.value)} style={{
                width: '100%',
                padding: '4px',
                border: '1px solid #d1d5db',
                borderRadius: '2px',
                fontSize: '12px'
                    ...
                    <input type="text" value={detalle.descripcion} onChange={(e) => handleDetalleChange(index, 'descripcion', e.target.value)} style={{
                width: '100%',
                padding: '4px',
                border: '1px solid #d1d5db',
                borderRadius: '2px',
                fontSize: '12px'
                    ...
                    <input type="number" min="1" value={detalle.cantidad} onChange={(e) => handleDetalleChange(index, 'cantidad', parseFloat(e.target.value))} style={{
                width: '100%',
                padding: '4px',
                border: '1px solid #d1d5db',
                borderRadius: '2px',
                ...
                textAlign: 'center'
                    ...
                    <input type="number" min="0" step="0.01" value={detalle.precio_unitario} onChange={(e) => handleDetalleChange(index, 'precio_unitario', parseFloat(e.target.value))} style={{
                width: '100%',
                padding: '4px',
                border: '1px solid #d1d5db',
                borderRadius: '2px',
            ...
            <div style={{ backgroundColor: 'white', padding: '16px', borderRadius: '8px', border: '1px solid #d1d5db' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '24px' }}>
                <div>
                  ...
                  <textarea value={formData.observaciones} onChange={(e) => handleInputChange('observaciones', e.target.value)} rows={4} style={{
            width: '100%',
            padding: '8px',
            border: '1px solid #d1d5db',
            borderRadius: '4px',
