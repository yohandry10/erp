...
exports.default = GreModal;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
function GreModal({ isOpen, onClose, onSuccess, cpeData }) {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <div>
            ...
            {cpeData && (<p style={{ fontSize: '0.9rem', color: '#22c55e', marginTop: '0.25rem', fontWeight: '500' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
            <div>
              ...
              <input type="text" name="destinatario" value={formData.destinatario} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              <input type="text" name="direccionDestino" value={formData.direccionDestino} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div>
              ...
              <input type="date" name="fechaTraslado" value={formData.fechaTraslado} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div>
              ...
              <select name="modalidad" value={formData.modalidad} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div>
              ...
              <select name="motivo" value={formData.motivo} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div>
              ...
              <input type="number" name="pesoTotal" value={formData.pesoTotal} onChange={handleChange} step="0.01" min="0" required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            {formData.modalidad === 'TRANSPORTE_PUBLICO' && (<div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', color: '#374151' }}>
                  Transportista
                </label>
                <input type="text" name="transportista" value={formData.transportista} onChange={handleChange} style={{
                width: '100%',
                padding: '0.75rem',
                border: '1px solid #d1d5db',
                borderRadius: '6px',
            ...
            {formData.modalidad === 'TRANSPORTE_PRIVADO' && (<>
                <div>
                  ...
                  <input type="text" name="placaVehiculo" value={formData.placaVehiculo} onChange={handleChange} style={{
                width: '100%',
                padding: '0.75rem',
                border: '1px solid #d1d5db',
                borderRadius: '6px',
                ...
                <div>
                  ...
                  <input type="text" name="licenciaConducir" value={formData.licenciaConducir} onChange={handleChange} style={{
                width: '100%',
                padding: '0.75rem',
                border: '1px solid #d1d5db',
                borderRadius: '6px',
