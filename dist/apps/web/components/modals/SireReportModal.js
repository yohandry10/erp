...
exports.default = SireReportModal;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
function SireReportModal({ isOpen, onClose, onSuccess }) {
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.5rem' }}>
            <div>
              ...
              <select name="tipoReporte" value={formData.tipoReporte} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            ...
            <div>
              ...
              <input type="month" name="periodo" value={formData.periodo} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                ...
                <input type="date" name="fechaInicio" value={formData.fechaInicio} onChange={handleChange} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.9rem'
              ...
              <div>
                ...
                <input type="date" name="fechaFin" value={formData.fechaFin} onChange={handleChange} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div>
              ...
              <select name="formato" value={formData.formato} onChange={handleChange} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <input type="checkbox" name="incluirAnulados" checked={formData.incluirAnulados} onChange={handleChange} id="incluirAnulados" style={{ width: 'auto' }}/>
