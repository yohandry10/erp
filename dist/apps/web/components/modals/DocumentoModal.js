...
exports.default = DocumentoModal;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
function DocumentoModal({ isOpen, onClose, onSuccess, documento }) {
    ...
    const [detalles, setDetalles] = (0, react_1.useState)([
        {
            codigo_producto: '',
            descripcion: '',
            unidad_medida: 'NIU',
    ...
    const [validandoRUC, setValidandoRUC] = (0, react_1.useState)(false);
    const [erroresValidacion, setErroresValidacion] = (0, react_1.useState)([]);
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        {erroresValidacion.length > 0 && (<div style={{
                background: '#fef2f2',
            ...
            <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#dc2626' }}>
              {erroresValidacion.map((error, index) => (<li key={index}>{error}</li>))}
            </ul>
          </div>)}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
              <div>
                ...
                <select value={formData.tipo_documento} onChange={(e) => setFormData(prev => ({ ...prev, tipo_documento: e.target.value }))} required style={{
            width: '100%',
            padding: '0.75rem',
            ...
            fontSize: '0.875rem'
              ...
              <div>
                ...
                <input type="text" value={formData.serie} onChange={(e) => setFormData(prev => ({ ...prev, serie: e.target.value }))} placeholder="Ej: F001, B001" style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.875rem'
              ...
              <div>
                ...
                <input type="date" value={formData.fecha_emision} onChange={(e) => setFormData(prev => ({ ...prev, fecha_emision: e.target.value }))} required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.875rem'
              ...
              <div>
                ...
                <input type="date" value={formData.fecha_vencimiento} onChange={(e) => setFormData(prev => ({ ...prev, fecha_vencimiento: e.target.value }))} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.875rem'
              ...
              <div>
                ...
                <select value={formData.moneda} onChange={(e) => setFormData(prev => ({ ...prev, moneda: e.target.value }))} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
              <div>
                ...
                <select value={formData.receptor_tipo_doc} onChange={(e) => setFormData(prev => ({ ...prev, receptor_tipo_doc: e.target.value }))} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            fontSize: '0.875rem'
              ...
              <div style={{ gridColumn: 'span 2' }}>
                ...
                <input type="text" value={formData.receptor_razon_social} onChange={(e) => setFormData(prev => ({ ...prev, receptor_razon_social: e.target.value }))} placeholder="Nombre o razón social del cliente" required style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.875rem'
              ...
              <div style={{ gridColumn: 'span 2' }}>
                ...
                <input type="text" value={formData.receptor_direccion} onChange={(e) => setFormData(prev => ({ ...prev, receptor_direccion: e.target.value }))} placeholder="Dirección del cliente" style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            fontSize: '0.875rem'
              ...
              <div>
                ...
                <input type="email" value={formData.receptor_email} onChange={(e) => setFormData(prev => ({ ...prev, receptor_email: e.target.value }))} placeholder="email@cliente.com" style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
          ...
          <div style={{ marginBottom: '2rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <button type="button" onClick={agregarDetalle} style={{
            padding: '0.5rem 1rem',
            background: '#3b82f6',
            color: 'white',
            border: 'none',
            ...
            {detalles.map((detalle, index) => (<div key={index} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  {detalles.length > 1 && (<button type="button" onClick={() => eliminarDetalle(index)} style={{
                    background: '#ef4444',
                    color: 'white',
                    border: 'none',
                    borderRadius: '4px',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem' }}>
                  <div>
                    ...
                    <input type="text" value={detalle.codigo_producto} onChange={(e) => actualizarDetalle(index, 'codigo_producto', e.target.value)} placeholder="COD001" style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div style={{ gridColumn: 'span 2' }}>
                    ...
                    <input type="text" value={detalle.descripcion} onChange={(e) => actualizarDetalle(index, 'descripcion', e.target.value)} placeholder="Descripción del producto/servicio" required style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div>
                    ...
                    <select value={detalle.unidad_medida} onChange={(e) => actualizarDetalle(index, 'unidad_medida', e.target.value)} style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div>
                    ...
                    <input type="number" step="0.01" value={detalle.cantidad} onChange={(e) => actualizarDetalle(index, 'cantidad', parseFloat(e.target.value) || 0)} required min="0" style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div>
                    ...
                    <input type="number" step="0.01" value={detalle.precio_unitario} onChange={(e) => actualizarDetalle(index, 'precio_unitario', parseFloat(e.target.value) || 0)} required min="0" style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div>
                    ...
                    <input type="number" step="0.01" value={detalle.descuento_unitario} onChange={(e) => actualizarDetalle(index, 'descuento_unitario', parseFloat(e.target.value) || 0)} min="0" style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
                fontSize: '0.875rem'
                  ...
                  <div>
                    ...
                    <input type="number" value={detalle.total_item.toFixed(2)} readOnly style={{
                width: '100%',
                padding: '0.5rem',
                border: '1px solid #d1d5db',
                borderRadius: '4px',
          ...
          <div style={{ marginBottom: '2rem', background: '#f9fafb', padding: '1rem', borderRadius: '8px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem' }}>
              <div>
                ...
                <input type="number" value={formData.subtotal.toFixed(2)} readOnly style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            color: '#6b7280'
              ...
              <div>
                ...
                <input type="number" value={formData.impuesto_igv.toFixed(2)} readOnly style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            color: '#6b7280'
              ...
              <div>
                ...
                <input type="number" step="0.01" value={formData.descuentos} onChange={(e) => setFormData(prev => ({ ...prev, descuentos: parseFloat(e.target.value) || 0 }))} min="0" style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px'
              ...
              <div>
                ...
                <input type="number" value={(formData.total - formData.descuentos).toFixed(2)} readOnly style={{
            width: '100%',
            padding: '0.75rem',
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <textarea value={formData.observaciones} onChange={(e) => setFormData(prev => ({ ...prev, observaciones: e.target.value }))} placeholder="Observaciones adicionales del documento..." rows={3} style={{
            width: '100%',
            padding: '0.75rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', paddingTop: '1rem', borderTop: '1px solid #e5e7eb' }}>
            ...
            <button type="submit" disabled={api.loading} style={{
            padding: '0.75rem 1.5rem',
            border: 'none',
            borderRadius: '6px',
