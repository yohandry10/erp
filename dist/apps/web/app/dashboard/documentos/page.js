...
exports.default = DocumentosPage;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
const DocumentoModal_1 = __importDefault(require("@/components/modals/DocumentoModal"));
function DocumentosPage() {
    const [documentos, setDocumentos] = (0, react_1.useState)([]);
    const [stats, setStats] = (0, react_1.useState)(null);
    const [isModalOpen, setIsModalOpen] = (0, react_1.useState)(false);
    const [selectedDocumento, setSelectedDocumento] = (0, react_1.useState)(null);
    ...
    const enviarSUNAT = async (documentoId) => {
    ...
    const generarXML = async (documentoId) => {
    ...
    const descargarPDF = async (documentoId, filename) => {
    ...
    const descargarXML = async (documentoId, filename) => {
    ...
    const anularDocumento = async (documentoId, motivo) => {
    ...
    return (<div className="dashboard-container">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <select value={filters.tipo_documento} onChange={(e) => setFilters(prev => ({ ...prev, tipo_documento: e.target.value }))} style={{
            width: '100%',
            padding: '0.5rem',
          ...
          <div>
            ...
            <input type="text" value={filters.receptor_numero_doc} onChange={(e) => setFilters(prev => ({ ...prev, receptor_numero_doc: e.target.value }))} placeholder="Buscar por documento..." style={{
            width: '100%',
            padding: '0.5rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px'
          ...
          <div>
            ...
            <input type="text" value={filters.serie} onChange={(e) => setFilters(prev => ({ ...prev, serie: e.target.value }))} placeholder="Ej: F001, B001..." style={{
            width: '100%',
            padding: '0.5rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px'
          ...
          <div>
            ...
            <input type="date" value={filters.fecha_desde} onChange={(e) => setFilters(prev => ({ ...prev, fecha_desde: e.target.value }))} style={{
            width: '100%',
            padding: '0.5rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px'
          ...
          <div>
            ...
            <input type="date" value={filters.fecha_hasta} onChange={(e) => setFilters(prev => ({ ...prev, fecha_hasta: e.target.value }))} style={{
            width: '100%',
            padding: '0.5rem',
            border: '1px solid #d1d5db',
            borderRadius: '6px'
      ...
      <div style={{
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {documentos.map((documento) => (<tr key={documento.id} style={{ borderBottom: '1px solid #e5e7eb' }}>
                  ...
                  <td style={{ padding: '1rem', fontSize: '0.875rem' }}>
                    <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                      {documento.estado === 'BORRADOR' && (<>
                          <button onClick={() => generarXML(documento.id)} style={{
                    ...
                    fontSize: '0.75rem'
                      ...
                      {documento.estado === 'EMITIDO' && (<button onClick={() => enviarSUNAT(documento.id)} style={{
                    ...
                    fontSize: '0.75rem'
                      ...
                      {['ENVIADO_SUNAT', 'ACEPTADO'].includes(documento.estado) && (<>
                          <button onClick={() => descargarPDF(documento.id, `${documento.serie}-${documento.numero}.pdf`)} style={{
                    ...
                    fontSize: '0.75rem'
                          ...
                          <button onClick={() => descargarXML(documento.id, `${documento.serie}-${documento.numero}.xml`)} style={{
                    background: 'rgba(59, 130, 246, 0.1)',
                    border: '1px solid rgba(59, 130, 246, 0.2)',
                    padding: '0.25rem 0.75rem',
                    borderRadius: '6px',
                    ...
                    fontSize: '0.75rem'
                      ...
                      {!['ANULADO'].includes(documento.estado) && (<button onClick={() => {
          ...
          {documentos.length === 0 && !api.loading && (<div style={{ textAlign: 'center', padding: '3rem', color: '#6b7280' }}>
      ...
      {/* Document Modal */}
      <DocumentoModal_1.default isOpen={isModalOpen} onClose={() => {
            setIsModalOpen(false);
            setSelectedDocumento(null);
        }} onSuccess={handleDocumentoCreated} documento={selectedDocumento}/>
