...
exports.default = CotizacionesPage;
const react_1 = require("react");
const use_api_1 = require("@/hooks/use-api");
const use_toast_1 = require("@/components/ui/use-toast");
const CotizacionModal_1 = __importDefault(require("@/components/modals/CotizacionModal"));
const CotizacionViewModal_1 = __importDefault(require("@/components/modals/CotizacionViewModal"));
function CotizacionesPage() {
    const { get } = (0, use_api_1.useApi)();
    const [cotizaciones, setCotizaciones] = (0, react_1.useState)([]);
    const [clientesTop, setClientesTop] = (0, react_1.useState)([]);
    ...
    const [showCotizacionModal, setShowCotizacionModal] = (0, react_1.useState)(false);
    const [showViewModal, setShowViewModal] = (0, react_1.useState)(false);
    const [selectedCotizacion, setSelectedCotizacion] = (0, react_1.useState)(null);
    ...
    const loadCotizaciones = async () => {
        try {
            ...
            if (filters.vendedor)
                params.append('vendedor', filters.vendedor);
    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-header">
        ...
        <button className="refresh-btn" onClick={loadData} style={{
        ...
        <button className="refresh-btn" onClick={handleCrearCotizacion} style={{
      ...
      <div className="activity-section">
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{
            ...
            <select value={filters.estado} onChange={(e) => handleFilterChange('estado', e.target.value)} style={{
            ...
            <input type="text" placeholder="Buscar por vendedor" value={filters.vendedor} onChange={(e) => handleFilterChange('vendedor', e.target.value)} style={{
            padding: '0.75rem 1rem',
            borderRadius: '8px',
            border: '1px solid #d1d5db',
            background: 'white',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <input type="date" value={filters.fecha_desde} onChange={(e) => handleFilterChange('fecha_desde', e.target.value)} style={{
            padding: '0.75rem 1rem',
            borderRadius: '8px',
            border: '1px solid #d1d5db',
            background: 'white',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <input type="date" value={filters.fecha_hasta} onChange={(e) => handleFilterChange('fecha_hasta', e.target.value)} style={{
            padding: '0.75rem 1rem',
            borderRadius: '8px',
            border: '1px solid #d1d5db',
            background: 'white',
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <button onClick={applyFilters} className="refresh-btn" style={{
            ...
            <button onClick={clearFilters} className="refresh-btn" style={{
      ...
      <div className="activity-section">
        ...
        <div className="activity-card">
          {cotizaciones.length === 0 ? (<div style={{
                textAlign: 'center',
                padding: '3rem',
                color: '#e2e8f0',
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                  {cotizaciones.map((cotizacion) => (<tr key={cotizacion.id} style={{
                    ...
                    : (cotizacion.estado?.toUpperCase() || 'BORRADOR')}
                      ...
                      <td style={{ padding: '1rem', backgroundColor: 'white' }}>
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                          <button onClick={() => handleVerCotizacion(cotizacion)} style={{
                    background: '#3b82f6',
                    color: 'white',
                    border: 'none',
...
✨ Se abrirá automáticamente el PDF generado...`);
      ...
      {/* Top Clients Section */}
      {clientesTop.length > 0 && (<div className="activity-section">
        <h2 className="activity-title">Clientes Principales</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem', marginTop: '1rem' }}>
            {clientesTop.slice(0, 3).map((cliente) => (<div key={cliente.id} className="activity-card" style={{ padding: '1.5rem' }}>
    ...
    <CotizacionModal_1.default isOpen={showCotizacionModal} onClose={() => setShowCotizacionModal(false)} onSuccess={handleCotizacionCreated}/>

    <CotizacionViewModal_1.default isOpen={showViewModal} onClose={() => {
