...
const UsuarioModal_1 = __importDefault(require("@/components/modals/UsuarioModal"));
...
function UsuariosPage() {
    ...
    const [filtroRol, setFiltroRol] = (0, react_1.useState)('todos');
    const [filtroEstado, setFiltroEstado] = (0, react_1.useState)('todos');
    const [modalOpen, setModalOpen] = (0, react_1.useState)(false);
    const [usuarioEditando, setUsuarioEditando] = (0, react_1.useState)(null);
    ...
    return (<div className="dashboard-container">
      ...
      <div className="activity-section">
        ...
        <div className="activity-card">
          {usuarios.length === 0 ? (<div className="text-center py-8">
              <p className="text-gray-500">No hay usuarios registrados en el sistema</p>
              <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700" onClick={handleNuevoUsuario}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                return (<tr style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }} key={usuario.id}>
                        ...
                        <td style={{ padding: '1rem', textAlign: 'center' }}>
                          <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'center' }}>
                            <button onClick={() => handleEditarUsuario(usuario)} style={{
                        ...
                        fontSize: '0.8rem'
                            ...
                            {usuario.estado === 'ACTIVO' ? (<button onClick={() => handleCambiarEstado(usuario, 'INACTIVO')} style={{
                            ...
                            fontSize: '0.8rem'
                                ...
                                Desactivar
                              </button>) : (<button onClick={() => handleCambiarEstado(usuario, 'ACTIVO')} style={{
      ...
      <div className="activity-section">
        ...
        <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
          {roles.map((rol, index) => (<div key={index} className="activity-card" style={{ padding: '1.5rem' }}>
              ...
              <div style={{
                ...
                try {
                    ...
                    return permisos.length > 0 ? permisos.map((permiso, pIndex) => (<span key={pIndex} style={{
                            background: 'rgba(16, 185, 129, 0.1)',
                            color: '#10b981',
      ...
      {/* Modal */}
      <UsuarioModal_1.default isOpen={modalOpen} onClose={() => setModalOpen(false)} onSuccess={fetchData} usuario={usuarioEditando} roles={roles}/>
    </div>);
}
