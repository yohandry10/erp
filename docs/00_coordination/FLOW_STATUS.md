...
| POS, ticket, pago, caja y CPE/outbox | Cerrado tecnico para flujo nuevo | `docs/auditoria_forense_contable_2026-05.md`, `docs/auditoria_forense_tesoreria_caja_bancos_cxc_cxp_2026-05.md`, `docs/manuals/modules/VENTAS_POS_FISCAL.md` | `327`, `334` | No degradar a fallback legacy en produccion; validar migracion aplicada y smoke con caja real |
...
| CPE/GRE fiscal | Validado en sandbox/local | `docs/auditoria_forense_contable_2026-05.md`, `docs/production-readiness/ERP_PRODUCTION_READINESS.md`, `docs/manuals/modules/VENTAS_POS_FISCAL.md` | `331`, `332` y fiscal previo | Certificado SUNAT/OSE productivo, CDR/ticket/acuse real |
