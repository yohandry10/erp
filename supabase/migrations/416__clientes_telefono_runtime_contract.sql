...
ALTER TABLE public.clientes
  DROP CONSTRAINT IF EXISTS ck_clientes_telefono_runtime_416;

ALTER TABLE public.clientes
  ADD CONSTRAINT ck_clientes_telefono_runtime_416
  CHECK (telefono IS NULL OR length(btrim(telefono)) BETWEEN 6 AND 20)
  NOT VALID;

ALTER TABLE public.clientes
  VALIDATE CONSTRAINT ck_clientes_telefono_runtime_416;
